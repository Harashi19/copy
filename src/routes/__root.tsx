...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A boutique guest house in Zvishavane, Zimbabwe. Quiet luxury, warm hospitality, elegant rooms." },
      { name: "author", content: "Trezia Apartments" },
